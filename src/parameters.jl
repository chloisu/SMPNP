...
@option struct Parameters
    ...
    D_ref::Float32 = 5e-9 # reference diffusivity [m^2/s]
    pore_radius::Float32 = 10e-9 # pore radius [meter]
    pore_length::Float32 = 50e-9 # pore length [meter]
    reservoir_height::Float32 = 80e-9 # reservoir height [meter]
    cation_size::Float32 = 5e-10 # cation size [meter]
    anion_size::Float32 = 5e-10 # cation size [meter]
    solvent_molecule_size::Float32 = 5e-10
    D_anion::Float32 = 5e-9 # anion diffusivity [m^2/s]
    D_cation::Float32 = 5e-9 # cation diffusivity [m^2/s]
    surface_potential::Float32 = 0.3# surface potential [V]
