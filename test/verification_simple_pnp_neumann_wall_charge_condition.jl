...
global ARGS = ["verification_simple_pnp_neumann_wall_charge_condition.yml"]  # Simulate command-line arguments
...
CairoMakie.save(joinpath(".", "verification_simple_pnp_neumann_wall_charge_condition.pdf"), reveal(p))  #hide