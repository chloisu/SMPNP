...
phi_analytical = potential_pb_1d_v2(grid, 0.3, 10e-9, 0.5 * MOL_PER_LITER_TO_PER_CUBIC_METER)
ca_analytical, cc_analytical = concentrations_pb_1d(grid, 0.3, 10e-9, 0.5 * MOL_PER_LITER_TO_PER_CUBIC_METER)
...
GLMakie.save(joinpath(".", "verification_simple_pnp_different_reference_concentration.jpg"), reveal(p))  #hide